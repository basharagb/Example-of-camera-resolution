...
abstract final class ShortVideoModel {
  static ShortVideoEntity fromJson(Map<String, dynamic> json) => ShortVideoEntity(
    id: _string(json['id']),
  ...
  static VideoCommentEntity commentFromJson(Map<String, dynamic> json) {
    final Map<String, dynamic> user = (json['user'] as Map?)?.cast<String, dynamic>() ?? const <String, dynamic>{};
  ...
  static String _string(Object? value, [String fallback = '']) => value?.toString() ?? fallback;
